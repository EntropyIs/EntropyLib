...
namespace Entropy
{
	namespace Math
	{
		...
		public:
			...
			Mat4(float** data) :
				R0C0(data[0][0]), R1C0(data[1][0]), R2C0(data[2][0]), R3C0(data[3][0]),
				R0C1(data[0][1]), R1C1(data[1][1]), R2C1(data[2][1]), R3C1(data[3][1]),
				R0C2(data[0][2]), R1C2(data[1][2]), R2C2(data[2][2]), R3C2(data[3][2]),
				R0C3(data[0][3]), R1C3(data[1][3]), R2C3(data[2][3]), R3C3(data[3][3]) {};
		};
	}
}
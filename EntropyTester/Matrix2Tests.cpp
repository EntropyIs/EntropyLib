...
TEST(Matrix2, Constructor)
{
	...
	FLOAT_EQ(empty.r0c0, 1); FLOAT_EQ(empty.r0c1, 0);
	FLOAT_EQ(empty.r1c0, 0); FLOAT_EQ(empty.r1c1, 1);

	FLOAT_EQ(a.r0c0, 1); FLOAT_EQ(a.r0c1, 2);
	FLOAT_EQ(a.r1c0, 3); FLOAT_EQ(a.r1c1, 4);
}
